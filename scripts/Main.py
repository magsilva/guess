...
def addNodeField(fieldName,sqlType,defaultValue):
	g.addNodeField(fieldName,sqlType,defaultValue)
...
def addEdgeField(fieldName,sqlType,defaultValue):
	g.addEdgeField(fieldName,sqlType,defaultValue)
